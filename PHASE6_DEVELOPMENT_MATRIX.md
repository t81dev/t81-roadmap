...
| P6-D2 | `t81-examples`, `t81-docs` | `@t81dev` | Keep a canonical consumer onboarding path current with active runtime contract baseline | `runtime-v0.5` canonical suite (`e2e`, `trap diagnostics`, `mode parity`) validated in CI and referenced in onboarding docs | https://github.com/t81dev/t81-roadmap/issues/20 |
